...
CFLAGS    = ${CFLAGS_CL} ${CFLAGS_V7} -O3 -Wall -Werror=return-type -std=gnu23 $(DEFINES)
CXX_FLAGS = ${CFLAGS_CL} ${CFLAGS_V7} -O3 -Wall -Werror=return-type -fno-rtti -fno-threadsafe-statics -fno-exceptions -std=gnu++23 -ffunction-sections -fdata-sections $(DEFINES)
